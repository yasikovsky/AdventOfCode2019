...
namespace Task3.Tests
{
    public class Task3Test
    {
        ...
        public void GetShortestDistance_ValueTest(string wire1, string wire2, int result)
        {
            var wireArray = new [] {wire1, wire2};
            Task3.GetShortestDistance(Task3.GetIntersections(wireArray)).ShouldBe(result);
        }
        ...
        public void GetClosestIntersection_ValueTest(string wire1, string wire2, int result)
        {
            var wireArray = new[] { wire1, wire2 };
            Task3.GetClosestIntersection(Task3.GetIntersections(wireArray)).ShouldBe(result);
        }
    }
}
